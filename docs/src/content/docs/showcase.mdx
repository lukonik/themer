...
// Usage
console.log(getFibonacci(10)); // Output: 55
```
...
| :------------------ | :------: | :------------: | :---------- |
| **Market Research** |   High   |    ✅ Done     | Sarah       |
| **UI Design**       |  Medium  | ⏳ In Progress | Alex        |
| **API Integration** |   High   |   ❌ Blocked   | Jordan      |
| **User Testing**    |   Low    |  📅 Scheduled  | Maria       |
